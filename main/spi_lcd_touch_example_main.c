...
#elif CONFIG_LCD_CONTROLLER_ILI9341
#include "esp_lcd_ili9341.h"
#elif CONFIG_LCD_CONTROLLER_GC9A01
#include "esp_lcd_gc9a01.h"
#endif

#if CONFIG_LCD_TOUCH_CONTROLLER_XPT2046
...
#if defined(CONFIG_LCD_CONTROLLER_ILI9341) || defined(CONFIG_LCD_CONTROLLER_GC9A01)
...
void app_main(void)
{
    ...
    if(panel_config.bits_per_pixel == 24) {
      draw_buffer_sz = LCD_H_RES * LVGL_DRAW_BUF_LINES * sizeof(lv_color_t);
    } else {
...
#elif CONFIG_LCD_TOUCH_CONTROLLER_STMPE610
    esp_lcd_panel_io_spi_config_t tp_io_config = ESP_LCD_TOUCH_IO_SPI_STMPE610_CONFIG(PIN_NUM_TOUCH_CS);
...
#if CONFIG_LCD_TOUCH_CONTROLLER_XPT2046
    ESP_LOGI(TAG, "Initialize touch controller XPT2406");
